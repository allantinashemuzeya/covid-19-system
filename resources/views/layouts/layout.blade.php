...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans&amp;family=Roboto:wght@300&amp;display=swap"
        rel="stylesheet" />
    <link rel="stylesheet" href="{{asset('lib/dm-file-uploader/css/jquery.dm-uploader.min.css')}}" />
    <link rel="stylesheet" href="{{asset('lib/select2/css/select2.min.css')}}" />


    <link rel="stylesheet" href="{{asset('css/site25e8.css?v=25BqWgxqBWj3SttJ38AUvXjzmMBVqsQj565Jge8CBnw')}}" />
</head>
...
<body class="bg-primary">
    ...
    <script src="{{asset('js/site746d.js?v=47DEQpj8HBSa-_TImW-5JCeuQeRkm5NMpJWZG3hSuFU')}}"></script>
    ...
    <script src="{{asset('lib/jquery-mask-plugin/jquery.mask.min.js')}}"></script>
